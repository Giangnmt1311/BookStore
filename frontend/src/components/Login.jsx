    ...
    const {
      ...
      const onSubmit = async (data) => {
        try {
            ...
            try { await fetch(`${getBaseUrl()}/api/auth/customers/sync`, { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ email: data.email, firebaseId }) }); } catch {}
            navigate("/")
        } catch (error) {
            ...
            try { 
                ...
                if(email){ 
                    await fetch(`${getBaseUrl()}/api/auth/customers/sync`, { 
                        ...
                        body: JSON.stringify({ email, username, firebaseId }) 
                    }); 
                } 
            } catch {}
            navigate("/")
