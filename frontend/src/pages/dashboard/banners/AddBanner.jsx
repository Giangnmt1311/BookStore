...
import { useAddBannerMutation } from '../../../redux/features/banners/bannersApi';
...
const AddBanner = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            await addBanner(newBanner).unwrap();
            Swal.fire({
                title: "Banner added",
                text: "Your banner is uploaded successfully!",
                icon: "success",
            ...
            const errorMessage = error?.message || error?.data?.message || "Failed to add banner. Please try again.";
            Swal.fire({
                title: "Error",
                text: errorMessage,
                icon: "error",
        ...
        <div className="max-w-2xl mx-auto">
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                <div className="bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-4">
                    <h2 className="text-2xl font-bold text-white">Add New Banner</h2>
                    <p className="text-indigo-100 text-sm mt-1">Fill in the details to add a new banner to the store</p>
                </div>
                        ...
                        >
                            {(isLoading || uploading) ? (
                                <span className="flex items-center justify-center">
                                    ...
                                    {uploading ? 'Uploading image...' : 'Adding Banner...'}
                                </span>
                            ) : (
