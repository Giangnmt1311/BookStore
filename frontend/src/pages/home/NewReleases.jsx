...
import { FiStar, FiShoppingCart, FiCalendar, FiTag } from 'react-icons/fi';
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between mb-8">
                    <div>
                        ...
                        <p className="text-lg text-gray-600">Fresh books just added to our collection</p>
                    </div>
                    <div className="flex items-center text-green-500">
                        <FiCalendar className="w-6 h-6 mr-2" />
                        <span className="font-semibold">Just Added</span>
                    </div>
                </div>
